...
<div class="main-wrapper">
    ...
    <div class="main-row">
        ...
        <div class="main-textbox">
            ...
            <button class="small-button" onclick="window.location.href='mailto:sealevelbuildersltd@gmail.com?subject=Sea%20Level%20Application'">Click to Apply</button>

            <button class="small-button" onclick="window.location.href='about.php'">About Our Company</button>
        </div>
        <!-- end main-text -->

        <div class="main-image">
            <img src="images/careerspage.jpg" alt="resume on desk">
        </div>
        <!-- end main-image -->
